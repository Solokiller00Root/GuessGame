      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={submitHandler} className="grid gap-4 py-4">
          <div className="grid items-center grid-cols-4 gap-4">
            ...
            <Input id="name" placeholder="Eagles" className="col-span-3" onChange={(e) => updateFormData("gameName", e.target.value)} />
          </div>
          <div className="grid items-center grid-cols-4 gap-4">
          ...
          <div className="grid items-center grid-cols-4 gap-4">
            ...
            <div onChange={(e: ChangeEvent<HTMLInputElement>) => updateFormData("privacy", e.target.value)} className="flex col-span-3 gap-x-4">
